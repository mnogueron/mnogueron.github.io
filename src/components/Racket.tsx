...
const Racket = (props: RacketProps) => {
  return (
    <chakra.svg
      ...
      {...props}
    >
      <path d="M106.231 48.1274H336.415" stroke="white" stroke-width="0.66" />
      <path d="M84.6514 67.7397H355.379" stroke="white" stroke-width="0.66" />
      <path d="M370.42 88.6841H67.6494" stroke="white" stroke-width="0.66" />
      <path d="M384.153 109.597H51.9541" stroke="white" stroke-width="0.66" />
      <path d="M44.1074 129.851H399.193" stroke="white" stroke-width="0.66" />
      <path d="M408.348 151.461H36.2607" stroke="white" stroke-width="0.66" />
      <path d="M416.195 170.414H27.7588" stroke="white" stroke-width="0.66" />
      <path d="M421.426 191.339H21.2188" stroke="white" stroke-width="0.66" />
      <path d="M16.6426 210.958H424.043" stroke="white" stroke-width="0.66" />
      <path d="M426.004 231.235H14.0264" stroke="white" stroke-width="0.66" />
      <path d="M8.79492 252.149H429.274" stroke="white" stroke-width="0.66" />
      <path d="M433.198 271.125H8.14062" stroke="white" stroke-width="0.66" />
      <path d="M6.17969 293.353H433.852" stroke="white" stroke-width="0.66" />
      <path d="M433.198 311.663H6.83398" stroke="white" stroke-width="0.66" />
      <path d="M8.79492 333.897H430.582" stroke="white" stroke-width="0.66" />
      <path d="M431.889 354.18H11.4102" stroke="white" stroke-width="0.66" />
      <path d="M17.9502 374.44H426.004" stroke="white" stroke-width="0.66" />
      <path d="M420.119 394.718H17.9512" stroke="white" stroke-width="0.66" />
      <path d="M27.7588 414.984H411.618" stroke="white" stroke-width="0.66" />
      <path d="M404.425 435.256H40.1846" stroke="white" stroke-width="0.66" />
      <path d="M57.8398 461.395H388.076" stroke="white" stroke-width="0.66" />
      <path
      ...
      <path
        ...
        stroke-width="0.66"
      />
      <path d="M245.524 6.27679V543.155" stroke="white" stroke-width="0.66" />
      <path d="M228.517 6.9303V546.425" stroke="white" stroke-width="0.66" />
      <path d="M211.526 6.92999V545.77" stroke="white" stroke-width="0.66" />
      <path d="M193.876 7.58411V543.809" stroke="white" stroke-width="0.66" />
      <path d="M176.88 10.2003V539.885" stroke="white" stroke-width="0.66" />
      <path
        d="M157.916 16.0855L160.531 534"
        stroke="white"
        stroke-width="0.66"
      />
      <path d="M140.908 21.3171V526.807" stroke="white" stroke-width="0.66" />
      <path d="M122.592 30.4721V520.268" stroke="white" stroke-width="0.66" />
      <path d="M103.627 40.9348V511.113" stroke="white" stroke-width="0.66" />
      <path
